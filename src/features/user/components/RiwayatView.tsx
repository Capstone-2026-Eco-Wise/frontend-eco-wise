      ...
      <div className="bg-white rounded-[32px] shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-8">
          <div className="space-y-4">
            {history.length > 0 ? (
              history.map((item) => (
                <div key={item.id} className="flex items-center justify-between p-4 rounded-2xl border border-slate-100 hover:border-[#10b981]/30 hover:bg-[#10b981]/5 transition-colors group">
                  <div className="flex items-center gap-4">
                    <div className="size-12 rounded-full bg-[#f4f7fb] group-hover:bg-white flex items-center justify-center shrink-0 transition-colors">
                      <Trash2 className="size-5 text-slate-400 group-hover:text-[#10b981] transition-colors" />
                    </div>
                    <div>
                      <h4 className="text-base font-bold text-[#1e293b] mb-1 truncate max-w-[150px] sm:max-w-xs">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className="text-sm font-extrabold text-[#10b981]">+{item.pointEarned} Poin</p>
                      <p className="text-xs font-medium text-slate-400">Selesai</p>
                    </div>
                    <div className="size-8 rounded-full bg-[#ecfdf5] hidden items-center justify-center sm:flex">
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-1">Belum Ada Riwayat</h3>
                <p className="text-slate-500">Mulai memindai sampah untuk mendapatkan poin pertamamu!</p>
              </div>
            )}
          </div>
        </div>
