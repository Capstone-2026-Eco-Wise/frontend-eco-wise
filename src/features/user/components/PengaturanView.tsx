  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl">
          ...
          >
            <div className="size-24 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border-2 border-slate-50">
              {isUploadingAvatar ? (
                ...
                <UserCircle className="size-24 text-slate-300 mt-4" />
              )}
            </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#10b981]/20 focus:border-[#10b981] transition-all text-sm"
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
        ...
        <div className="p-8 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          {!showPasswordChange ? (
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-slate-700 transition-colors w-full sm:w-auto justify-center"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-red-500 hover:text-red-600 transition-colors w-full sm:w-auto justify-center"
            >
      ...
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent className="rounded-[32px] p-8 border-0 shadow-2xl max-w-md">
          <div className="flex flex-col items-center text-center space-y-4">
            <div className="size-16 rounded-full bg-[#ecfdf5] flex items-center justify-center mb-2">
              <CheckCircle2 className="size-8 text-[#10b981]" />
            </div>
            <AlertDialogHeader>
              <AlertDialogTitle className="text-2xl font-extrabold text-[#1e293b] text-center">
                Sukses!
              </AlertDialogTitle>
              <AlertDialogDescription className="text-slate-500 font-medium text-base text-center pt-2">
