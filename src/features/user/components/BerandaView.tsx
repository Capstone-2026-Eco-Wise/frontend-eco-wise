      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] p-6 shadow-sm border border-slate-100 dark:border-slate-800 h-fit flex flex-col">
          ...
          <div className="flex flex-col gap-3">
            {leaderboardLoading ? (
              <p className="text-slate-400 dark:text-slate-500 font-medium text-xs text-center py-6">
                Memuat klasemen...
              </p>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span
                            className={`size-6 rounded-full border flex items-center justify-center text-xs font-extrabold shrink-0 ${rankStyles[index] || "bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700"}`}
                          >
                            {index + 1}
                          </span>
                          ...
                          <div className="truncate max-w-[100px] sm:max-w-[150px] lg:max-w-[90px]">
                            <p
                              className={`text-sm font-bold truncate ${isMe ? "text-emerald-900 dark:text-emerald-400" : "text-slate-800 dark:text-slate-200"}`}
                            >
                        ...
                        <span
                          className={`text-xs font-extrabold ${isMe ? "text-emerald-700 dark:text-emerald-400" : "text-slate-600 dark:text-slate-350"}`}
                        >
                ...
                {(() => {
                  const myRank =
                    leaderboard.findIndex(
                      (entry) => entry.username === userData?.data?.username,
                    ) + 1;
                  ...
                  return myRank > 0 ? (
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-center">
                      <p className="text-[10px] font-medium text-slate-400 dark:text-slate-500">
                        Belum masuk klasemen. Selesaikan misi pertama Anda!
                      </p>
                    </div>
                  );
                })()}
