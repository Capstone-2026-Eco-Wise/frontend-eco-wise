                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center justify-between sm:justify-end w-full sm:w-auto gap-3 shrink-0">
                      ...
                      {isCompleted ? (
                        <span className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-100 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-450 font-bold text-xs sm:text-sm border border-emerald-200/30">
